...
public class GripPipeline implements VisionPipeline {
	...
	private ArrayList<double[]> targetData = new ArrayList<double[]>();//This is the output that is used in CIAVisionThread
	...
	@Override	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = CIAConstants.hsvThresholdHue;
		double[] hsvThresholdSaturation = CIAConstants.hsvThresholdSaturation;
		double[] hsvThresholdValue = CIAConstants.hsvThresholdValue;
		...
		ticks++;
		if(timer >= 1000000000){//measure frames per second
	...
	private void filterContours(List<MatOfPoint> inputContours, double minArea,
		...
		for (int i = 0; i < inputContours.size(); i++) {
			...
			double[] data = {centerX, centerY, bb.width, bb.height, ratio, area};// x, y, width, height, ratio, area
			targetData.add(data);
		}
	}
